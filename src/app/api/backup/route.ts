  ...
  try {
    ...
    if (!client) {
      ...
      const result = await db.$transaction(async (tx) => {
        ...
        // Insertar asignaturas primero (preservando ID)
        ...
        // Insertar alumnos (preservando ID)
        ...
        // Insertar profesores (preservando ID)
        ...
        // Insertar notas al final (preservando ID y relaciones)
